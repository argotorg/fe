...
fn source_registry(bundle: &DebugBundle) -> (Vec<&DebugSourceFile>, BTreeMap<OriginExportKey, u32>) {
...
fn ethdebug_instruction(
    ...
    EthdebugInstruction {
        ...
        confidence: crate::model::wire_enum_label(&instruction.confidence),
        classification: crate::model::wire_enum_label(&instruction.classification),
    }
}
