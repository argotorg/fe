...
use crate::{
    ...
    hir_def::{
        ...
        ContractRecvArm, ContractRecvArmListId, DeriveDecl, DeriveProviderScope, EffectParam,
...
pub mod prelude {
    pub use super::{
        ...
        walk_derive_provider_scope, walk_effect_param, walk_effect_param_list, walk_enum,
        walk_expr, walk_field, walk_field_def, walk_field_def_list, walk_field_list, walk_func,
