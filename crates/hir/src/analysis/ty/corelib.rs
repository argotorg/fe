...
pub fn runtime_builtin_func_kind<'db>(
    ...
    Some(match (kind, path.as_slice()) {
        ...
        (IngotKind::Std, ["evm", "ops", "extcodecopy_raw"]) => RuntimeBuiltinFuncKind::ExtCodeCopy,
        (IngotKind::Std, ["evm", "ops", "extcodesize_raw"]) => RuntimeBuiltinFuncKind::ExtCodeSize,
        (IngotKind::Std, ["evm", "ops", "extcodehash_raw"]) => RuntimeBuiltinFuncKind::ExtCodeHash,
        ...
        (IngotKind::Std, ["evm", "ops", "balance_raw"]) => RuntimeBuiltinFuncKind::Balance,
