...
impl<'db, 'a> FunctionHasher<'db, 'a> {
    ...
    fn hash_function(&mut self, func: &MirFunction<'db>) {
        ...
        match func.receiver_space {
            ...
            Some(crate::ir::AddressSpaceKind::Calldata) => self.write_u8(2),
            Some(crate::ir::AddressSpaceKind::Storage) => self.write_u8(3),
            Some(crate::ir::AddressSpaceKind::TransientStorage) => self.write_u8(4),
    ...
    fn hash_value(&mut self, value: &crate::ValueData<'db>) {
        ...
        match value.repr {
            ...
            ValueRepr::Ref(crate::ir::AddressSpaceKind::Calldata) => self.write_u8(2),
            ValueRepr::Ref(crate::ir::AddressSpaceKind::Storage) => self.write_u8(3),
            ValueRepr::Ref(crate::ir::AddressSpaceKind::TransientStorage) => self.write_u8(4),
            ValueRepr::Ptr(crate::ir::AddressSpaceKind::Memory) => self.write_u8(5),
            ValueRepr::Ptr(crate::ir::AddressSpaceKind::Calldata) => self.write_u8(6),
            ValueRepr::Ptr(crate::ir::AddressSpaceKind::Storage) => self.write_u8(7),
            ValueRepr::Ptr(crate::ir::AddressSpaceKind::TransientStorage) => self.write_u8(8),
        }
        ...
        match origin {
            ...
            ValueOrigin::FieldPtr(field_ptr) => {
                ...
                self.write_u8(match field_ptr.addr_space {
                    ...
                    crate::ir::AddressSpaceKind::Calldata => 2,
                    crate::ir::AddressSpaceKind::Storage => 3,
                    crate::ir::AddressSpaceKind::TransientStorage => 4,
                });
            }
